    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-medium text-xs rounded-xl shadow-sm transition-all flex items-center gap-2"
        >
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-xs border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
          />
        </div>
      </div>
      ...
      {loading ? (
                    ...
                    <tr key={item.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 bg-purple-100 rounded-xl flex items-center justify-center text-purple-700 font-bold shrink-0">
                          ...
                          <div>
                            ...
                            <div className="text-[11px] text-slate-500 font-mono">
                              Reg: <span className="font-semibold text-purple-700">{car.car_number}</span> | Eng: {car.engine_number}
                            </div>
                          </div>
                        </div>
                      </td>
                      ...
                      {/* Agreed Commission */}
                      <td className="py-3.5 px-4">
                        <div className="font-bold text-purple-700 bg-purple-50 border border-purple-200 px-2.5 py-1 rounded-lg inline-block">
                        ...
                        {item.status === 'ACTIVE' ? (
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <button
                              ...
                              className="px-2.5 py-1.5 bg-slate-100 hover:bg-rose-50 text-slate-700 hover:text-rose-600 border border-slate-200 rounded-lg transition-all flex items-center gap-1"
                            >
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center space-y-3 shadow-sm">
          <div className="w-16 h-16 bg-purple-50 text-purple-500 rounded-2xl flex items-center justify-center mx-auto">
