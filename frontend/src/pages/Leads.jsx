  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-white tracking-tight">Customer CRM & Buyer Leads</h1>
          <p className="text-xs text-slate-400 mt-1">Lead pipeline, follow-up call history, and smart inventory budget matcher</p>
        </div>

        <button
          onClick={() => setIsAddLeadOpen(true)}
          className="px-5 py-2.5 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-white font-bold text-xs rounded-xl shadow-lg shadow-amber-600/25 flex items-center gap-2 transition-all"
        >
      ...
      {/* Filter Tabs */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 flex items-center gap-2 overflow-x-auto shadow-xl">
                    ...
                    <tr key={lead.id} className="hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-4 px-6">
                        <select
                          ...
                          className="px-2.5 py-1 bg-slate-950 border border-slate-800 rounded-lg text-xs font-bold text-amber-400 focus:outline-none"
                        >
                      ...
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-2.5 py-1.5 bg-indigo-600/20 hover:bg-indigo-600/30 text-indigo-400 border border-indigo-500/30 font-semibold rounded-lg transition-all flex items-center gap-1"
                          >
                          ...
                          <button
                            ...
                            className="px-2.5 py-1.5 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-400 border border-emerald-500/30 font-semibold rounded-lg transition-all flex items-center gap-1"
                          >
