  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-extrabold text-white tracking-tight">Employees, Dealers & Payroll Engine</h1>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2.5 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-400 border border-emerald-500/30 font-bold text-xs rounded-xl transition-all flex items-center gap-2"
          >
                  ...
                  employees.map((emp) => (
                    <tr key={emp.id} className="hover:bg-slate-800/40 transition-colors">
                      ...
                      <td className="py-4 px-6">
                        <span className="px-2.5 py-1 rounded-lg text-[11px] font-extrabold bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                          {emp.designation}
                        </span>
                      </td>

                      <td className="py-4 px-6 font-mono text-slate-400">{emp.cnic}</td>
                      <td className="py-4 px-6 text-slate-300">{emp.phone}</td>
              ...
              {payrolls.length > 0 ? (
                payrolls.map((pay) => (
                  <tr key={pay.id} className="hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="py-4 px-6 text-rose-400 font-semibold">
