...
async def lifespan(app: FastAPI):
    ...
    # Startup: ensure database tables are created and schema is updated
...
# CORS Middleware Configuration (Allows local development, all Vercel domains, and fallback wildcard)
origins = [
    "http://localhost:5173",
    "http://localhost:3000",
    "http://127.0.0.1:5173",
...
app.include_router(
    consignments_router,
    prefix=f"{settings.API_V1_STR}/consignments",
    tags=["Consignment Sales & Commission"],
)
app.include_router(
    repairs_router,
